...
class ExpectedViewHelper extends \F3\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	public function render($regex = FALSE) {
		...
		$this->viewHelperVariableContainer->add('F3\Viewhelpertest\ViewHelpers\ExpectedViewHelper', 'source', $source);
		$this->viewHelperVariableContainer->add('F3\Viewhelpertest\ViewHelpers\ExpectedViewHelper', 'regex', $regex);
	}
}
